...
public class Again : Perk
{
    ...
    //This is where the perk activates. This changes the reload speed of the player.
    ...
    //This is where the perk deactivates. This changes the reload speed of the player.
