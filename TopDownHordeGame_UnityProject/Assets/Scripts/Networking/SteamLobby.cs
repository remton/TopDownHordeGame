...
public class SteamLobby : NetworkBehaviour
{
    ...
    public void CloseLobby(CSteamID lobbyID) {
        Debug.Log("Closeing lobby . . .");
        foreach (PlayerConnection playerConn in networkManager.players) {
            playerConn.LeaveLobby(lobbyID);
        }
    }
